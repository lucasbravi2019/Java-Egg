...
public class Ejercicio28 {
    public static void main(String[] args) {
        ...
        // Contar coordenadas para las cuales coincide el primer valor de la matriz
        // chica
        contador = 0;
        for (int i = 0; i < 10; i++) {
            for (int j = 0; j < 10; j++) {
        ...
        // Vectores de posicion en los que las coordenadas son iguales al primer numero
        // de la matriz chica
        ...
        for (int i = 0; i < contador; i++) {
            ...
            for (int j = absc[i]; j < absc[i] + 3; j++) {
                ...
                for (int k = ord[i]; k < ord[i] + 3; k++) {
                    ...
                    // Cada vez que los valores sean iguales se suma un contador para luego
                    // verificar si es o no una matriz P contenida dentro de la matriz M
            ...
            // Se verifica que la cantidad de valores iguales sea igual que el rango de la
            // matriz chica, es decir, 3 * 3 = 9
            if (iguales == 9) {
